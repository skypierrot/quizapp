...
const mockSubjectPerformanceData: SubjectPerformanceStat[] = [
  { subject: '데이터베이스', solvedCount: 120, correctCount: 90, correctRate: 0.75 },
  { subject: '소프트웨어 공학', solvedCount: 95, correctCount: 70, correctRate: 0.73 },
  { subject: '네트워크', solvedCount: 110, correctCount: 80, correctRate: 0.72 },
  { subject: '알고리즘', solvedCount: 150, correctCount: 125, correctRate: 0.83 },
  { subject: '운영체제', solvedCount: 80, correctCount: 50, correctRate: 0.62 },
];
